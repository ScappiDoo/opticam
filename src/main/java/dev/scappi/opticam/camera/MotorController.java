...
public final class MotorController {
    ...
    public static void update(CameraSession session, float targetYaw, float targetPitch) {
        ...
        // Apply the smoothed + clamped motor values (never teleport).
        // This enforces the ±MAX_YAW pan / ±MAX_PITCH tilt limits and the
        // gradual MOTOR_SPEED sweep, giving the camera its motorized feel.
